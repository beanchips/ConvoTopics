...
- (NSArray *) theContent
{
    if(_theContent == nil){
        ...
        _theContent = [[NSArray alloc] initWithObjects:
                       ...
                       @"Would you be willing to spend a night alone in a supposedly haunted house?", 
                       @"Of 100 randomly chosen people your age, how many do you think are leading a life more satisfying than yours?", 
                       @"Does each person have just one soul mate?", 
                       @"In 100 years, do you think the world will be a better or worse place?",
                       @"If you could be world champion at a particular sport, which sport would you choose?", 
                       @"What do you wear when you're home alone?", 
                       @"Would you eat a bowl of live earthworms for $40,000?",
                       ...
                       @"If you were guaranteed honest answers to 3 questions, who would you question and what would you ask?",
                       @"What was your best experience with drugs or alcohol? Your worst experience?", 
                       
                       @"Is it better to have unfulfilled dreams, or no dreams at all?",
                       @"Who's the most famous person you've ever met?", 
                       @"Would you be comfortable going alone to dinner or to a movie?", 
                       @"When did you last yell at someone and what was it for?", 
                       @"What's your dream job?", 
                       
                       @"At age 90, would you rather have the mind or the body of a 30 year old?", 
                       @"Would you accept 20 years of exceptional happiness and fulfillment if it meant you would die right after?", 
                       @"What's the most exotic thing you've ever eaten?", 
                       @"How would you react if you learned your significant other has had a lover of the same gender?", 
                       @"Would you want your spouse to be smarter and more attractive than you?", 
                        
                       @"What is something you haven't yet done but would like to do before you die?",
                       @"Would you get a finger surgically removed if it meant immunity from major diseases?", 
                       @"Would you want to be famous? What would you like to be famous for?", 
                       @"Would you rather love your spouse more than they love you, or vice versa?", 
                       @"If you were offered immortality, would you take it?",
                    
                       
                       @"If there were a public execution on TV, would you watch it?", 
                       @"If you could time travel to the future with no way of returning, would you? Would this change if you could bring someone along?", 
                       @"Would you generally prefer to be overdressed or underdressed for a party?",                              
                       @"When you are around people you don't care for, do you act as if you enjoy their company to be polite?",
                       @"If you were offered the job of president of the United States, would you accept it?",                       
                       ...
                       @"Would you get yourself frozen when you die in order to be reanimated later?", 
                       @"Which would you prefer free services for a year from: a housekeeper, cook, or personal secretary?", 
                       ...
                       @"Would you kill 1 person to save 10 people? How about 10,000 people?",
                       ...
                       @"What types of things are you willing to splurge on?"
...
{   
    switch (result)
    {
        case MFMailComposeResultCancelled:
            ...
            [Flurry logEvent:@"Email_cancelled"];
            break;
...
- (void)messageComposeViewController:(MFMessageComposeViewController *)controller didFinishWithResult:(MessageComposeResult)result
{
	switch (result) {
		case MessageComposeResultCancelled:
			NSLog(@"Cancelled");
            [Flurry logEvent:@"SMS_cancelled"];
			break;
		case MessageComposeResultFailed:
            NSLog(@"Failed.");
            [Flurry logEvent:@"SMS_failed"];
            
			break;
		case MessageComposeResultSent:
            NSLog(@"SMS message sent.");
            [Flurry logEvent:@"SMS_sent"];
			break;
		default:
			break;
	}
